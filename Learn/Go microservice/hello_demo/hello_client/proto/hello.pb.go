...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //1是字段序号
}
...
type HelloResponse struct {
	...
	Reply string `protobuf:"bytes,1,opt,name=reply,proto3" json:"reply,omitempty"` //1是字段序号
}
